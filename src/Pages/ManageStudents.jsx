  ...
  const addStudent = async () => {
    try {
      const resp = await axios.post(
        "https://63fca9d9677c41587310eaca.mockapi.io/students",
        studentFormData
      );
    } catch (err) {
      // Handle Error Here
  ...
  const updateStudent = async () => {
    try {
      const resp = await axios.put(
        `https://63fca9d9677c41587310eaca.mockapi.io/students${studentFormData.id}`,
        studentFormData
      );
    } catch (err) {
      // Handle Error Here
    ...
    <div>
      ...
      >
        <div className="container">
          ...
          <p>
            We are proud to say that our students have gone on to attend some of
            the top universities and companies around the world. At Elakkiya, we
            measure our success by the success of our students, and we are
            dedicated to providing the highest quality educational services to
